// OpenAPI 3.1.2 "source of truth" for YumIA CRM Public API (Integrations).
//
// NOTE:
...
export function getPublicApiOpenApiDocument(): OpenApiDocument {
  return {
    openapi: '3.1.2',
    info: {
      title: 'YumIA CRM Public API',
      version: 'v1',
      description:
        'API pública do YumIA CRM para integrações (n8n/Make). Produto em primeiro lugar: copiar → colar → testar.',
    },
